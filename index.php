...
<html class="no-js" lang="en">
	...
	<body>
		...
		<?php if (!empty($banners)): ?>
            ...
            <!-- đoạn CODE STUDY4 HOÀN THIỆN đã thay thế-->
		<section id="hero-study4">
    <div class="hero-overlay">
        <div class="container">
            <div class="hero-content">
                <h1>Nền tảng học tập trực tuyến hiệu quả</h1>
                <p>
                    Luyện thi – Học tập – Nâng cao kỹ năng mọi lúc, mọi nơi cùng ChillEnglish
                </p>

                <div class="hero-actions">
                    <a href="new-arrivals.php" class="btn-hero primary">
                        <i class="fa fa-graduation-cap"></i> Bắt đầu học
                    </a>
                    <a href="genre/genres.php" class="btn-hero secondary">
                        <i class="fa fa-book"></i> Danh mục khóa học
                    </a>
                </div>
            </div>
        </div>
		...
		<section id="new-arrivals" class="section-padding">
			<div class="container">
				<div class="section-title">
                    ...
                    <p class="text-center">Các khóa học được nhiều học viên lựa chọn</p>
				...
				<div class="text-center">
					<a href="new-arrivals.php" class="btn-view-more">Xem tất cả khóa học</a>
				</div>
			</div>
		</section>
		<!--new-arrivals end -->
		...
		<section id="artists" class="artists section-padding">
			<div class="container">
                ...
                <p class="text-center">Đội ngũ giảng viên giàu kinh nghiệm</p>
				...
				<div class="text-center">
					<a href="Artists/Artists.php" class="btn-view-more">Xem tất cả giảng viên </a>
				</div>
			</div>
		</section><!--/.artists-->
		<!--feature end -->
		...
		<section id="genres" class="genres section-padding">
			<div class="container">
				<div class="section-title">
					<h2>Lĩnh vực học tập</h2>
                    <p class="text-center">Đa dạng lĩnh vực – Phù hợp mọi trình độ</p>
                    <div class="text-center">
					<a href="genre/genres.php" class="btn-view-more">
                        Xem tất cả lĩnh vực
                    </a>
				    </div>
		...
		<section id="vouchers" class="vouchers section-padding" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
			<div class="container">
				<div class="section-title">
					<h2>Ưu đãi học tập</h2>
                    <p class="text-center">Nhận voucher để học với chi phí tốt nhất</p>
